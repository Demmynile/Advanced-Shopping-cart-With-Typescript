		...
		<NavbarBs  sticky = "top" className = "bg-white shadow-sm mb-3" >
			<Container>
				...
				<Nav className = "mr-auto gap-4"  >
					<Nav.Link to = "/" as={NavLink} className = "text-primary fw-bold f">
                        Home
					</Nav.Link>
					<Nav.Link to = "/store" as={NavLink} className = "text-primary fw-bold" >
                        Store
					</Nav.Link>
					<Nav.Link to = "/about" as={NavLink} className = "text-primary fw-bold">
                        Contact Us
					</Nav.Link>
				</Nav>
